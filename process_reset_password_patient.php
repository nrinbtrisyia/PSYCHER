...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($newPassword !== $confirmNewPassword) {
        ...
        header("Location: p_res_pass.php");
        exit;
    }

    $uid = $_SESSION["userID"];
    $sql = "SELECT pass FROM patient_login WHERE p_ssn = ?";
    ...
    echo "Retrieved Password: {$row['pass']}<br>";
    ...
    $update_sql = "UPDATE patient_login SET pass = ? WHERE p_ssn = ?";
